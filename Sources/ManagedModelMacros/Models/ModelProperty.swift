...
extension ModelProperty.PropertyType: CustomStringConvertible {
    ...
    var description: String {
        ...
        case .attribute(_, let isTransformable):
...
extension ModelMacro {
    ...
    static func findModelProperties(
   ...
   */
    static func addModelProperties<T>(
        in member: T,
        ...
        for attribute: AttributeListSyntax.Element in attributes {
            ...
            case .attribute(let attribute):
                ...
                case "Attribute":
                    ...
                    case .attribute(_, _):
                        context.diagnose(
                            .multipleAttributeMacrosAppliedOnProperty,
                            on: attributes)
                    case .relationship(_):
                        context.diagnose(
        ...
        -> Bool
    {
        guard let arguments = syntax.arguments,
            case .argumentList(let labeledExpressions) = arguments
        else {
            return false
        }
        ...
        for labeledExpression in labeledExpressions {
            ...
            guard
                let funCall = labeledExpression.expression
            ...
            guard
                case .identifier(let name) =
                    member.declName.baseName.tokenKind
            else {
                continue
            }
